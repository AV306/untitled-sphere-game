...
/** @type {string} */
const CACHE_VERSION = '1733289293|439496604';
/** @type {string} */
const CACHE_PREFIX = 'untitled-sphere--sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'untitled-sphere-game.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["untitled-sphere-game.html","untitled-sphere-game.js","untitled-sphere-game.offline.html","untitled-sphere-game.icon.png","untitled-sphere-game.apple-touch-icon.png","untitled-sphere-game.worker.js","untitled-sphere-game.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["untitled-sphere-game.wasm","untitled-sphere-game.pck"];
